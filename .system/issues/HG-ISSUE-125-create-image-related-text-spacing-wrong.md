---
{ "status": "fixed", "specs": ["HG-SPEC-016", "HG-SPEC-004", "HG-SPEC-015"] }
---
...
Fix: grouped the Create → Image prompt-optimizer checkbox and helper text in one option group, tightened their internal gap, and separated the unrelated Generate action with larger margin. Added static, integration, and Chrome E2E proximity regressions. Cross-ref HG-ISSUE-117, HG-ISSUE-078, HG-ISSUE-116, HG-ISSUE-121.
