...
function createDraftFromDom() {
  return {
    ...
    music: {
      ...
      cover_source_kind: $("#cover-source-kind").value,
      cover_audio_url: $("#cover-audio-url").value,
      cover_style: $("#cover-style").value,
      cover_feature_id: $("#cover-feature-id").value,
      cover_lyrics: $("#cover-lyrics").value
    },
    voice: {
...
function applyCreateDraft(draft) {
  ...
  $("#cover-source-kind").value = draft.music.cover_source_kind ?? "direct";
  $("#cover-audio-url").value = draft.music.cover_audio_url ?? "";
  $("#cover-style").value = draft.music.cover_style ?? "";
  $("#cover-feature-id").value = draft.music.cover_feature_id ?? "";
  $("#cover-lyrics").value = draft.music.cover_lyrics ?? "";
...
function init() {
  ...
  const coverSourceKind = $("#cover-source-kind");
  const coverAudioUrl = $("#cover-audio-url");
  const coverAudioFile = $("#cover-audio-file");
  const coverStyle = $("#cover-style");
  const coverPreprocess = $("#cover-preprocess");
  const coverFeatureId = $("#cover-feature-id");
  const coverStatus = $("#cover-status");
  const coverLyrics = $("#cover-lyrics");
  const coverGenerate = $("#cover-generate");
