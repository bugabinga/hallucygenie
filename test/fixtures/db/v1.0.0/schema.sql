...
CREATE INDEX idx_sessions_active_updated ON sessions (archived_at, updated_at DESC);

CREATE INDEX idx_tool_input_history_session_kind ON tool_input_history (session_id, kind, hidden_at, created_at DESC);
